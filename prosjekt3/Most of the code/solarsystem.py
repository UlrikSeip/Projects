...
class solsys():
    ...
    def simulate(self, inFile, outFile, time = 10, dt = 1e-4, plott = "true", intgrat = 1, acc_func=2, int_func = 1): #, names = ["Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptun", "Pluto"]):
        names = []
        masses = []
        for i in range(len(self.planets)):
